# 06. API・イベント・Plugin契約
    ...
    | Method | Path | 用途 |
|---|---|---|
| `POST` | `/v1/personas` | Persona Contractの作成 |
| `POST` | `/v1/personas/{personaId}/versions` | 新Versionの作成 |
| `POST` | `/v1/personas/{personaId}/versions/{version}/compile` | Compiled Bundleの生成 |
| `GET` | `/v1/personas/{personaId}/versions/{version}/diff/{otherVersion}` | Version差分の取得 |
| `POST` | `/v1/plugins/validate` | Plugin適合性の検証 |
    ...
    {
      "eventId": "evt_...",
      "eventType": "aster.resource.changed.v1",
